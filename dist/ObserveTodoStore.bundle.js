(function () {
	...
	var ObserveTodoStore = (_class = function () {
	    function ObserveTodoStore() {
	        var _this = this;

	        classCallCheck(this, ObserveTodoStore);
	    ...
	    createClass(ObserveTodoStore, [{
	        ...
	        value: function add(task) {
	            ...
	            this.todos.push(_extends({}, cfg, { task: task }));
	        }
	    }, {
	    ...
	    return ObserveTodoStore;
	}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "todos", [observable], {
	    enumerable: true,
	    initializer: function initializer() {
	        return [];
	    }
	}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "pendingRequests", [observable], {
	    enumerable: true,
	    initializer: function initializer() {
	        return 0;
	    }
	}), _applyDecoratedDescriptor(_class.prototype, "completedTodosCount", [computed], Object.getOwnPropertyDescriptor(_class.prototype, "completedTodosCount"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "report", [computed], Object.getOwnPropertyDescriptor(_class.prototype, "report"), _class.prototype)), _class);
